<x-layout>
    ...
    <header>
        <div class="headerImg">
            ...
            <img src="/img/sfondo_iniziale.jpg" alt="" class="imgHeader"> 
        </div>
    ...
    <div id="menu">
        ...
        <body>
            <h2 class="mt-5">Yanai Kitchen Menu</h2>
            ...
            <div class="menu-section mb-5">
                ...
                <div class="category">
                    ...
                    <div class="menu-item mt-5">
                        <h2>SAUTEED EDEMAME  <span class="price">50k</span></h2>
                        <p>miso paste, soy sauce, mirin</p>
                    </div>
                    <div class="menu-item">
                        <h2>SUNONOMO SALAD <span class="price">65k</span></h2>
                        <p>Local Prawns, cucumber, wakame seaweed, ginger </p>
                    </div>
                    
                    <div class="menu-item">
                        <h2>POTATO SALAD <span class="price">80k</span></h2>
                        <p>soft boiled egg, crispy pancetta, japanese mayo </p>
                    </div>
                    
                    <div class="menu-item">
                        <h2>VEGGIE’S TEMPURA <span class="price">75k</span></h2>
                        <p>tentsuyu sauce, seasonal vegetables  </p>
                    </div>
                    
                    
                    <div class="menu-item">
                        <h2>COLD SOBA NOODLES <span class="price">85k</span></h2>
                        <p> hot dashi broth, spring onion, wasabi </p>
                    </div>
                </div>
                ...
                <div class="category">
                    ...
                    <h2>Mains</h2>
                    <div class="menu-item mt-5">
                        <h2>MISO RAMEN  <span class="price">145k</span></h2>
                        <p>soft boiled egg, chicken meatballs, spring onions, garlic oil</p>
                    </div>
                    <div class="menu-item">
                        <h2>EGGPLANT’S DONBURI<span class="price">110k</span></h2>
                        <p>steamed rice, grilled eggplant, shitake mushrooms, ginger, sesame seeds.</p>
                    </div>
                    <div class="menu-item">
                        <h2>GYUKATSU <span class="price">295k</span></h2>
                        <p>breaded 200gr black angus striploin, cabbage salad, steam rice, sesame dressing</p>
                    </div>
                    <div class="menu-item">
                        <h2>CHIRASHI  <span class="price">195k</span></h2>
                        <p>sushi rice, roasted eel, japanese scallops, salmon roe, shichimi, spring onion</p>
                    </div>
                </div>
                ...
                <div class="category">
                    ...
                    <h2>Dessert</h2>
                    <div class="menu-item mt-5">
                        <h2>CHOCOLATE & YUZU CAKE <span class="price">60k</span></h2>
                        
                    </div>
                    <div class="menu-item">
                        <h2>MACHA CHEESECAKE <span class="price">65k</span></h2>
        ...
        <h2 class="mt-5">Yanai sushi Menu</h2>
                ...
                <div class="col-12 col-md-3 custom-margin ">
                    <div class="row text-center">
                        <div class="col-12">
                            ...
                            <div class=" mt-2">
                                ...
                                <p>Hamachi <span class="price">80k</span></p> 
                                <p>salmon <span class="price">80k</span></p>
                                <p>asparragus <span class="price">75k</span></p>
                    ...
                    <div class="category">
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <p>Salmon Loin <span class="price">55k</span></p> 
                            <p>Hamachi (japanese amberjack) <span class="price">60k</span></p>
